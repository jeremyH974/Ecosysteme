...
const situation = SITUATIONS.find((s) => s.id === "independant")!;

export const metadata: Metadata = {
  title: "Outils pour independants — Ecosysteme",
  description:
    "Calculateurs gratuits pour freelances et independants : comparateur SASU vs AE, auto-entrepreneur, optimisation SASU. Sources officielles.",
  openGraph: {
    title: "Outils pour independants — Ecosysteme",
    description: "Choisissez le bon statut et optimisez votre revenu net.",
    type: "website",
  },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: situation.title, item: "https://ecosysteme-tools.vercel.app/situations/independant" },
            ],
          }),
        }}
      />
      ...
      <main className="mx-auto max-w-5xl px-5 py-10">
        <div className="mb-8">
          <h1 className="text-xl font-bold text-foreground sm:text-2xl">
            Vous vous lancez a votre compte {situation.icon}
          </h1>
          <p className="mt-2 text-sm text-muted max-w-2xl">
            {situation.accroche}. Micro-entreprise ou SASU ? Quel revenu net apres cotisations et impots ? Ces simulateurs vous aident a prendre la bonne decision.
          </p>
        </div>
