...
const situation = SITUATIONS.find((s) => s.id === "impots")!;

export const metadata: Metadata = {
  title: "Outils declaration d\u2019impots — Ecosysteme",
  description:
    "Calculateurs gratuits pour votre declaration : TMI, frais reels, indemnites km, niveau de richesse. Sources officielles.",
  openGraph: {
    title: "Outils declaration d\u2019impots — Ecosysteme",
    description: "Optimisez avant de declarer : comparez, simulez, decidez.",
    type: "website",
  },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Impots", item: "https://ecosysteme-tools.vercel.app/situations/impots" },
            ],
          }),
        }}
      />
      ...
      <main className="mx-auto max-w-5xl px-5 py-10">
        <div className="mb-8">
          <h1 className="text-xl font-bold text-foreground sm:text-2xl">
            Vous preparez votre declaration d&apos;impots {situation.icon}
          </h1>
          <p className="mt-2 text-sm text-muted max-w-2xl">
            {situation.accroche}. Frais reels ou forfait 10% ? Quel sera votre taux d&apos;imposition ? Ces calculateurs vous aident a optimiser avant de declarer.
          </p>
        </div>
