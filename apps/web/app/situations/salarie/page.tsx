...
const situation = SITUATIONS.find((s) => s.id === "salarie")!;

export const metadata: Metadata = {
  title: "Outils pour salaries — Ecosysteme",
  description:
    "Calculateurs gratuits pour les salaries : brut/net, rupture conventionnelle, allocations chomage, jours ouvres. Sources officielles.",
  openGraph: {
    title: "Outils pour salaries — Ecosysteme",
    description: "Comprenez votre salaire et anticipez les grandes transitions.",
    type: "website",
  },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: situation.title, item: "https://ecosysteme-tools.vercel.app/situations/salarie" },
            ],
          }),
        }}
      />
      ...
      <main className="mx-auto max-w-5xl px-5 py-10">
        <div className="mb-8">
          <h1 className="text-xl font-bold text-foreground sm:text-2xl">
            Vous etes salarie {situation.icon}
          </h1>
          <p className="mt-2 text-sm text-muted max-w-2xl">
            {situation.accroche}. Que vous prepariez une negociation salariale, envisagiez un depart ou vouliez simplement comprendre votre fiche de paie, ces outils vous donnent les chiffres exacts.
          </p>
        </div>
