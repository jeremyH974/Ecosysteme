...
export const metadata: Metadata = {
  title: "3 000 EUR brut en net 2026 — Calcul et detail",
  description:
    "3 000 EUR brut en net : ~2 340 EUR non-cadre, ~2 250 EUR cadre. Detail cotisations, PAS et comparaison SMIC/median.",
  openGraph: {
    title: "3 000 EUR brut en net 2026 — Calcul et detail",
    description: "Conversion 3 000 EUR brut en net avec detail des cotisations et comparaison.",
    type: "article",
  },
};

const COTISATIONS = [
  { nom: "CSG/CRDS", montant: "287" },
  { nom: "Assurance vieillesse", montant: "219" },
  { nom: "Retraite complementaire AGIRC-ARRCO", montant: "95" },
  { nom: "Autres (CEG, chomage...)", montant: "59" },
];

const FAQ = [
  { q: "3 000 EUR brut, ca fait combien en net ?", a: "Pour un salarie non-cadre, 3 000 EUR brut correspond a environ 2 340 EUR net avant impot. Pour un cadre, le net est d&apos;environ 2 250 EUR en raison de cotisations plus elevees (APEC, prevoyance, AGIRC-ARRCO tranche 2)." },
  { q: "3 000 EUR brut, est-ce au-dessus du salaire median ?", a: "Oui. Le salaire net median en France est d&apos;environ 2 183 EUR (INSEE 2024). Avec 2 340 EUR net (non-cadre), vous etes au-dessus du median, ce qui signifie que vous gagnez plus que la moitie des salaries francais." },
  { q: "Combien d&apos;impot pour 3 000 EUR brut ?", a: "Pour un celibataire sans enfant, le prelevement a la source est d&apos;environ 7,5%, soit environ 175 EUR/mois. Le net apres impot est donc d&apos;environ 2 165 EUR pour un non-cadre." },
  { q: "3 000 EUR brut annuel, ca donne quoi ?", a: "3 000 EUR brut mensuel = 36 000 EUR brut annuel. En net annuel : environ 28 080 EUR (non-cadre) ou 27 000 EUR (cadre), avant prelevement a la source." },
];
...
export default function Page3000BrutEnNet() {
  return (
    <>
      <Breadcrumb items={[{ label: "Accueil", href: "/" }, { label: "Guides" }, { label: "3 000 EUR brut en net" }]} />

      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "Article",
        headline: "3 000 EUR brut en net 2026 — Calcul et detail",
        description: "Conversion complete de 3 000 EUR brut en net pour cadre et non-cadre.",
        ...
        mainEntityOfPage: "https://ecosysteme-tools.vercel.app/guides/3000-brut-en-net",
      })}} />
      ...
      <article className="mx-auto max-w-3xl px-5 py-10">
        <header>
          ...
          <h1 className="mt-2 text-2xl font-extrabold tracking-tight text-foreground sm:text-3xl">
            3 000 EUR brut en net 2026 : calcul et detail
          </h1>
          <p className="mt-3 text-base text-muted">
            Combien fait 3 000 EUR brut en net ? Resultat pour non-cadre et cadre, detail des cotisations
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border bg-surface-card p-5 text-center">
            ...
            <p className="mt-2 text-3xl font-bold text-primary">2 340 EUR</p>
          ...
          <div className="rounded-xl border border-border bg-surface-card p-5 text-center">
            ...
            <p className="mt-2 text-3xl font-bold text-foreground">2 250 EUR</p>
            <p className="text-xs text-muted">net avant impot / mois</p>
          </div>
        </div>
        ...
        <Section title="Detail des cotisations (non-cadre)" id="cotisations">
          <p>
            Sur un salaire brut de 3 000 EUR, les cotisations salariales s&apos;elevent a environ 660 EUR
            pour un non-cadre :
          </p>
        ...
        <Section title="Impact du prelevement a la source" id="pas">
          <p>
            ...
            Pour un celibataire sans enfant avec 3 000 EUR brut, le taux de PAS est d&apos;environ 7,5% :
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li><strong className="text-foreground">Net avant PAS :</strong> 2 340 EUR (non-cadre)</li>
            <li><strong className="text-foreground">PAS (~7,5%) :</strong> -175 EUR</li>
            <li><strong className="text-foreground">Net apres PAS :</strong> ~2 165 EUR</li>
          </ul>
        </Section>
        ...
        <Section title="Comparaison avec le SMIC et le salaire median" id="comparaison">
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-lg border border-primary/30 bg-primary-light p-3 text-center">
              <p className="text-lg font-bold text-primary">2 340 EUR</p>
              <p className="text-xs text-muted">3 000 brut (net)</p>
            </div>
          </div>
          <p>
            Un salaire de 3 000 EUR brut se situe 62% au-dessus du SMIC et 7% au-dessus du salaire median.
            Cela place le salarie dans la tranche superieure a la mediane. Pour situer votre revenu :{" "}
